	...
	*/
	...
	{ 
		...
		UnSelectAnswer(sibling, $section);		
			...
			<div id="menu" style="margin-left:20px;margin-bottom:2px;margin-top:10px">
				<div id = 'togglemenu' class="dropdown">
				   <input type="button" class="dropbtn" value="TOGGLE OPTIONS" />
				   <div class="dropdown-content">
						<a href="##" onclick="toggle_metadata();">Metadata</a>		
						<a href="##" onclick="toggle_id();">IDs</a>					
						<a href="##" onclick="toggle_deprecated();">Deprecated</a>			
						<a href="##" class="collapse_all_control">Toggle All</a>	
						<a href="##" class="collapse_control">Toggle Sections</a>
						<a href="##" class="collapse_q_control">Toggle Questions</a>
					</div>
				</div>
			
				   <input id="btnParameters" type="button" class="dropbtn" style="margin-left:10px;"  value = "PACKAGE PARAMETERS"/>
				   <input id="btnRetrieveResponse" type="button" class="dropbtn"  style="margin-left:20px;" value = "RETRIEVE RESPONSE"/>
				...
				<div class="BodyGroup">
					...
					<div id="MessageData" style="display:none;">
						...
						<div id="receiverresponse"/>
						
						</div>
						<!--<div class="SubmitButton">
								<input type="button" value="Back" onClick="javascript:closeMessageData()" />
						</div>-->
						<a id='anotherpackage1' href="formfillerstep2.html">Select another package</a>
					</div>
					<br style="clear:both"/>
		...
		<a id='anotherpackage' href="formfillerstep2.html">Select another package</a>
    </xsl:template>
   
    <xsl:template match="//x:Header"></xsl:template>
											...
											<xsl:when test="count(ancestor::x:Section)= 0">
												<div class="{$defaultStyle} collapsable">
													...
													<div style="display:inline" class="MetadataDisplay">
														<!---metadata-->
														<xsl:call-template name="CommonAttributesForSection"/>
													</div>													
												</div>
												<xsl:if test="string(x:ChildItems/x:ButtonAction/@title) != '' ">
												<div class="buttonAction">
													<input type="button" value="Calculate Stage"/></div>	
												</xsl:if>
												<div style='clear:both'/>
											</xsl:when>
			...
			<div class='question'>
				...
				<div class="QuestionInSection">   <!--two columns-->
					...
					<xsl:if test="not(x:ResponseField) and not(@readOnly)">
						<a class="QuestionReset" onclick="resetAnswer(this);return false">
...
<xsl:template match="x:ListField" mode="level1">
	...
	<xsl:template name="QuestionSectionAttributes">
      <xsl:if test="$metadata-display = 'true'">
         <div class="MetadataDisplay" style="display:inline-block">
         	<xsl:if test="string(@readOnly) = 'true'">
      ...
      <xsl:if test="$metadata-display = 'true'">
         <div class="MetadataDisplay">
			...
			<!-- GOT HERE LI-3 -->
         	...
         	<!--	<xsl:if test="string(x:ResponseField/x:ResponseUnits/@unitSystem) != ''">
			
         		&#160;<div class="ResponseUnits">unitSystem: </div>
         		<xsl:value-of select="x:ResponseField/x:ResponseUnits/@unitSystem"/>
            </xsl:if>
         	<xsl:if test="string(x:ListItemResponseField/x:ResponseUnits/@unitSystem) != ''">
         		
         		&#160;<div class="ResponseUnits">unitSystem: </div>
         		<xsl:value-of select="x:ListItemResponseField/x:ResponseUnits/@unitSystem"/>
         	</xsl:if>-->
			...
			<!-- GOT HERE R-3 -->
         	...
         	<xsl:if test="string(x:ResponseField/x:Response/x:string/@name) !='' ">
         		<!-- GOT HERE R-3 -->
         		&#160;<div class="ResponseUnits">dt: </div><div class="metadataTextValue">string</div>
         		&#160;	<!--<div class="responseRequired">maxLength: </div> <xsl:value-of select="x:ResponseField/x:Response/x:string/@maxLength"/> -->
         		<!-- <xsl:value-of select="x:ResponseField/x:Response/@val"/>-->
         	</xsl:if>	
         	<xsl:if test="string(x:ListItemResponseField/x:Response/x:string/@name) !='' ">
         		<!-- GOT HERE R-3 -->
         		&#160;<div class="ResponseUnits">dt: </div><div class="metadataTextValue">string</div>
         		&#160;	<!--<div class="responseRequired">maxLength: </div> <xsl:value-of select="x:ListItemResponseField/x:Response/x:string/@maxLength"/> -->
         		<!-- <xsl:value-of select="x:ResponseField/x:Response/@val"/>-->
         	</xsl:if>	
         	<xsl:if test="string(x:ListItemResponseField/x:Response/x:decimal/@name) !='' ">
         		<!-- GOT HERE R-3 -->
         		&#160;<div class="ResponseUnits">dt: </div><div class="metadataTextValue">decimal</div>
         		&#160;	<!--<div class="responseRequired">maxLength: </div> <xsl:value-of select="x:ListItemResponseField/x:Response/x:string/@maxLength"/> -->
         		<!-- <xsl:value-of select="x:ResponseField/x:Response/@val"/>-->
         	</xsl:if>	
         	<xsl:if test="string(x:ResponseField/x:Response/x:decimal/@name) !='' ">
         		<!-- GOT HERE R-3 -->
         		&#160;<div class="ResponseUnits">dt: </div><div class="metadataTextValue">decimal</div>
         		&#160;	<!--<div class="responseRequired">maxLength: </div> <xsl:value-of select="x:ResponseField/x:Response/x:string/@maxLength"/> -->
         		<!-- <xsl:value-of select="x:ResponseField/x:Response/@val"/>-->
         	</xsl:if>
         	<xsl:if test="string(x:ListItemResponseField/x:Response/x:integer/@name) !='' ">
         		<!-- GOT HERE R-3 -->
         		&#160;<div class="ResponseUnits">dt: </div><div class="metadataTextValue">integer</div>
         		&#160;	<!--<div class="responseRequired">maxLength: </div> <xsl:value-of select="x:ListItemResponseField/x:Response/x:string/@maxLength"/> -->
         		<!-- <xsl:value-of select="x:ResponseField/x:Response/@val"/>-->
         	</xsl:if>	
         	<xsl:if test="string(x:ResponseField/x:Response/x:integer/@name) !='' ">
         		<!-- GOT HERE R-3 -->
         		&#160;<div class="ResponseUnits">dt: </div><div class="metadataTextValue">integer</div>
         		&#160;	<!--<div class="responseRequired">maxLength: </div> <xsl:value-of select="x:ResponseField/x:Response/x:string/@maxLength"/> -->
         		<!-- <xsl:value-of select="x:ResponseField/x:Response/@val"/>-->
   ...
   <xsl:template name="CommonAttributes">
      ...
      <xsl:if test="$metadata-display = 'true'">
         <div class="{string($metadataClass)}" style="display:inline">
            ...
            <xsl:if test="string(@mustImplement) = 'false'">
         	...
         	<xsl:if test="string(@maxSelections)!='0' and string(@maxSelections) != '' ">
         		&#160;<div class="maxSelections">maxSel: </div>
         		<xsl:value-of select="@maxSelections"/>
         	</xsl:if>
         	<xsl:if test="string(x:ListField/@maxSelections)!='0' and string(x:ListField/@maxSelections) != '' ">
         		&#160;<div class="maxSelections">maxSel: </div>
         		<xsl:value-of select="x:ListField/@maxSelections"/>
         	</xsl:if>
            ...
            <!-- </xsl:if> -->
         	...
         	<xsl:if test="string(x:Property/@val) != ''">  		
         			<xsl:if test="string(x:Property/@propName) = 'reportText'">
         				&#160;<div class="reportText">
         			rptText:
         				</div>
         			</xsl:if>
         			<xsl:if test="string(x:Property/@propName) = 'altText'">
         				<div class="altText">
         					altText:
         				</div>
         			</xsl:if>			
	...
	<xsl:template name="CommonAttributesForSection">
		<xsl:param name="metadataClass" select="'MetadataDisplay'"/>
		<xsl:if test="$metadata-display = 'true'">
			<div class="{string($metadataClass)}" style="display:inline">
				<!-- unnecessary logging -->
				<xsl:if test="string(@readOnly) = 'true'">
					&#160;<div class="lockedSection">locked</div>
				</xsl:if>
				<xsl:if test="string(@mustImplement) = 'false'">
					&#160;<div class="mustImplement">mI: </div>
					<xsl:value-of select="@mustImplement"/>
